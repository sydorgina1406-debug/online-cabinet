          ...
          <div className="bg-white rounded-[2rem] p-6 md:p-8 max-w-5xl w-full shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar" onClick={e => e.stopPropagation()}>
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-xl mb-8 shadow-sm">
              ...
              <p className="text-sm text-red-800 mt-2 leading-relaxed">
                Видеозвонок в кабинете идёт через внешний сервис (Zoom, Телемост, MAX, VK-звонки) — это надёжнее, чем встроенная связь. <b>Порядок действий</b>:
              </p>
              <ol className="list-decimal list-inside text-sm text-red-800 mt-2 font-bold space-y-2">
                <li><b>Один раз нажмите «Добавить звонок»</b> в верхней панели и вставьте свою постоянную ссылку на видеозвонок (Zoom, Телемост, MAX и т.п.).</li>
                <li>Ссылка сохраняется в комнате — при следующих сессиях вставлять её заново не нужно, только меняйте, если она поменялась.</li>
                <li><b>Отправляйте клиенту одну ссылку на платформу</b> — кнопка «Видеозвонок» появится у него сама, как только вы добавили ссылку.</li>
                ...
                <div className="text-sm text-gray-700 leading-relaxed px-2 space-y-3">
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                    ...
                    <ul className="text-xs space-y-1 list-disc list-inside">
                      ...
                      <li>Общая рубашка колоды — файл со словом <b>«рубашка»</b> в названии. Если такого файла нет, рубашка будет зелёной.</li>
                      <li><b>Своя рубашка у каждой карты</b> (например, двусторонние карты): назовите карты числами <b>1</b>, <b>2</b>, <b>3</b>, а их обороты — <b>1-1</b>, <b>2-1</b>, <b>3-1</b>.</li>
                      <li>Внимание: как только в папке появляется хоть один файл вида <b>N-1</b>, колода переходит в этот режим. Тогда все карты нужно называть числами — файлы с другими названиями окажутся в конце колоды и без рубашки.</li>
                      <li>Файл со словом <b>«коробк»</b> станет картинкой коробки колоды — но только в колодах с оборотами <b>N-1</b>. В обычной колоде такой файл станет ещё одной картой, лучше держать его вне папки.</li>
                      <li>Колоды больше 100 карт подтягиваются целиком — папка читается по частям.</li>
                    </ul>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex flex-col gap-3 flex-shrink-0">
                      <div className="rounded-2xl p-3 text-[9px] leading-relaxed" style={{ backgroundColor: `${COLORS.forest}12`, color: COLORS.forest, border: `1px solid ${COLORS.forest}25` }}>
                        ...
                        <div className="space-y-1 font-medium" style={{ color: `${COLORS.ink}99` }}>
                          ...
                          <div>6. <b>Рубашка колоды</b> — файл со словом "рубашка". Без него рубашка будет зелёной.</div>
